...
internal static class EnvironmentInfo
{
    ...
    /// <summary>
    /// Collects SChannel event log entries. Call this AFTER TLS validation tests
    /// so that events generated by those tests are captured in the report.
    /// </summary>
    public static void CollectSChannelEventLog(DiagnosticReport report)
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
